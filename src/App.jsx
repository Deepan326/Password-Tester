...
<div className="details">
  <div className="detail-item">
    Uppercase{" "}
    <img src={hasUppercase ? tick : cross} alt="check" className="crossTick" />
  </div>
  <div className="detail-item">
  Lowercase{" "}
    <img src={hasLowercase ? tick : cross}  alt="check" className="crossTick" />
  </div>
  <div className="detail-item">
  Number{" "}
    <img src={hasNumber ? tick : cross} alt="check" className="crossTick" />
  </div>
  <div className="detail-item">
  Special Character{" "}
    <img src={hasSpecial ? tick : cross}  alt="check" className="crossTick" />
  </div>
</div>
